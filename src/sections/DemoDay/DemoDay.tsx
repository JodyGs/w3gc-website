  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="md:grid18 px-2 md:col-span-full md:px-0"
      >
        <SectionHeading className="grid16 col-span-16" title="Demo Day" />
        <motion.div
          variants={ITEM_VARIANTS}
          className="cols-pan-full grid18 space-y-8 pt-8 md:space-y-0 lg:pt-20"
        >
          <HorizontalSlider
      ...
      <motion.div
        variants={ITEM_VARIANTS}
        className="space-y-4 px-2 pt-8 sm:flex sm:items-center sm:justify-center sm:space-x-2 sm:space-y-0 md:hidden"
      >
