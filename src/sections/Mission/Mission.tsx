...
import { ITEM_VARIANTS, CONTAINER_VARIANTS } from "~/utils/anim";
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="md:col-span-16 md:grid16 col-span-full px-2 md:px-0"
      >
        <SectionHeading
        ...
        <motion.div
          variants={ITEM_VARIANTS}
          className="relative col-span-full mt-12 min-h-[600px] flex-wrap space-y-4 sm:flex sm:space-y-0 xl:mt-40"
        >
          {DATA_CARD.map(
            (
          ...
          <motion.div
            variants={ITEM_VARIANTS}
            className="bottom-[68%] left-[26.2%] -z-10 hidden h-[25.33%] w-[22.7%] scale-110 xl:absolute xl:block"
          >
            <Image
          ...
          <motion.div
            variants={ITEM_VARIANTS}
            className="bottom-[25.2%] right-[13.3%] -z-10 hidden h-[44%] w-[24%] scale-110 xl:absolute xl:block"
          >
            <Image
